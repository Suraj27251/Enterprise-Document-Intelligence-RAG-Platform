...
If you browse only the root URL and see `{"detail":"Not Found"}`, that means the app has no root route in that deployed revision. Redeploy the latest commit (this one adds `/`).
